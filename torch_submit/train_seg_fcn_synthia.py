...
from dataset.synthia_dataset import SynthiaDataSet, Cityscapes16DataSetLMDB
...
def get_arguments():
    ...
    parser.add_argument("--data_dir", type=str, 
                        default='/home/users/liangchen.song/data/seg/synthia',
    ...
    parser.add_argument("--data_list", type=str, 
                        default='/home/users/liangchen.song/data/seg/image_list/synthia.txt',
