...
from adv_model_deeplabv3 import StyleTrans
...
def get_options():
    ...
    parser.add_argument("--resume", type=str,
                        default='/home/users/liangchen.song/data/models/trained/')
    # loss params
    ...
    parser.add_argument("--deeplabv3_name", type=str, default='deeplabv3.pth')
